            ...
            {REGIONS.map((r, i) => (
              <li
                ...
                style={{
                  padding: "16px 20px",
                  borderBottom:
                    i === REGIONS.length - 1 ? "none" : "1px solid var(--rule)",
      ...
      <section className="r-section">
        <div className="r-wrap-narrow">
          ...
          <p className="r-body" style={{ marginBottom: 16 }}>
            ...
            change it: <span style={{ fontFamily: "var(--font-mono)", fontSize: 13.5 }}>Workspace → Settings → Data → Retention.</span>
          </p>
          <p className="r-body">
            Set it to 7, 30, 90, 180, 365 days, or a custom value up to 7
            years. Enterprise plans support per-session legal hold.
          </p>
        </div>
      </section>
