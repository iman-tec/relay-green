      ...
      <section className="r-page-header">
        <div className="r-wrap-narrow">
          ...
          <p className="r-lede" style={{ marginTop: 24 }}>
            Four answers to four questions: who is allowed in, what protects
            the data once they are, what stops the platform from being a single
            point of failure, and which humans we trust enough to put behind
            the dot.
          </p>
        </div>
      </section>
      ...
      <section className="r-section">
        <div className="r-wrap-narrow">
          <p className="r-body" style={{ marginBottom: 24 }}>
            Auditor reports — including SOC 2 Type II once issued — are
            available to enterprise prospects under NDA.{" "}
            <Link
