 ...
 * link routes through /company/about#contact.
 */
...
export const metadata: Metadata = {
  title: "Compliance",
  description:
    "Current compliance posture across SOC 2 readiness, GDPR, HIPAA, ISO 27001 planning, DPDP, and CCPA.",
  ...
  return (
    <Shell>
      <section className="r-page-header">
        <div className="r-wrap-narrow">
          ...
          <p className="r-lede" style={{ marginTop: 24 }}>
            ...
            governs how Relay handles customer data, what it covers, what window
            it applies to, and where to read further.
          </p>
        </div>
      </section>
      ...
      <section className="r-section">
        <div className="r-wrap-narrow">
          {/* Wrapped in r-grid-table-scroll so the dense 4-col matrix
              scrolls horizontally on phones rather than squeezing into
              illegible columns. min-width on the inner table opts in
              to scrolling below ~720 px. */}
