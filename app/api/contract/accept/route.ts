...
export async function POST(request: Request) {
  ...
  // 'declined' is acceptable too — the customer can change their mind and
  // commit a bid they'd previously rejected (the viewer offers exactly that).
  if (quote.status !== "quoted" && quote.status !== "declined")
