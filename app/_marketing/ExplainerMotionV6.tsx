...
const PHASES = [
  ...
  {
    id: "03",
    label: "Maintain & Scale",
    role: "Your engineer takes accountability.",
  },
] as const;
  ...
  return (
    <Frame>
      <div style={SCENE_STAGE}>
        ...
        <Beat6Phases
          activeIndex={
            current.id === "6a-phase1"
              ? 0
              : current.id === "6b-phase2"
                ? 1
                : current.id === "6c-phase3"
                  ? 2
                  : current.id === "6d-relay"
                    ? 3
                    : -1
  ...
  return (
    <div
      style={{
        ...
        opacity: active ? 1 : 0,
        transition:
          "transform 480ms cubic-bezier(.2,.7,.2,1), opacity 360ms ease-out",
      }}
    >
      ...
      >
        {PHASES.map((p, i) => (
          <div
            ...
            style={{
              textAlign:
                i === 0 ? "left" : i === PHASES.length - 1 ? "right" : "center",
