...
/*
 * Enterprise-scoped Add Employee drawer. POSTs to
 * /api/enterprise/departments/:deptId/employees — invites + transfers
 * initial minutes from the dept pool.
 */
...
export function AddEmployeeDrawer({
  ...
  const submit = async () => {
    ...
    setError(null);
    try {
      const res = await fetch(`/api/enterprise/departments/${deptId}/employees`, {
        method:  "POST",
