    ...
    >
      <div className="mb-1 flex items-center gap-2">
        {icon ? (
          <span
            style={{
              color: accent ? "var(--primary-hover)" : "var(--text-muted)",
            }}
          >
            {icon}
          </span>
...
export function EditableField({
  ...
  return (
    <div
      className="flex flex-col gap-1.5 border-t py-3 first:border-t-0 sm:flex-row sm:items-center sm:justify-between"
      ...
      {!readOnly && onSave ? (
        editing ? (
          ...
          <button
            ...
            className="inline-flex shrink-0 items-center gap-1 rounded-md border px-2.5 py-1.5 text-xs"
...
export function IdentityBlock({ name, sub }: { name: string; sub?: string }) {
  ...
  return (
    <div className="mb-4 flex items-center gap-3">
      <span
        className="inline-flex size-14 items-center justify-center rounded-2xl font-serif text-xl font-semibold"
        style={{
