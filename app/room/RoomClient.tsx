...
import {
  ...
  Wallet, RefreshCw, Settings, LogOut, Check, Folder, Pencil,
} from "lucide-react";
...
const Sidebar = memo(function Sidebar({
  ...
  onViewPast, onNewSession, onStartInProject, onRenameProject, onWalletClick,
}: {
  email: string;
...
const ProjectAccordion = memo(function ProjectAccordion({
  group, viewingPastId, currentSessionId, onViewPast, onStartInProject, onRenameProject,
}: {
  group: ProjectGroup;
  viewingPastId: string | null;
