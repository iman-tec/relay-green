...
export const metadata: Metadata = {
  title: "Relay — Acceptable Use Policy",
  description:
      ...
      <section className="r-section" style={{ paddingTop: 0, borderTop: "none" }}>
        <div className="r-wrap-narrow">
          ...
          <p className="r-body" style={bodyStyle}>
            ...
            something we, or the engineer who shows up, would refuse on
            ethical grounds. This policy is the short list of work we will not
            staff — and the only list. We don&rsquo;t hide anything else
            behind &ldquo;at our discretion.&rdquo; Everything else, we
            answer.
          </p>
          ...
          <p className="r-body" style={bodyStyle}>
            ...
            content that sexually exploits minors; build software whose
            primary purpose is to deceive a person about who they are
            interacting with; build tools that surveil people without their
            knowledge; circumvent another company&rsquo;s security; violate a
            sanctioned-party export control. We reserve the right to decline
            any session for any reason; we will tell you why.
          </p>
          ...
          <p className="r-body" style={bodyStyle}>
            ...
            , as applicable. If we&rsquo;re compelled by law to report, we
            will, and we&rsquo;ll tell you we did unless we&rsquo;re legally
            barred.
          </p>
