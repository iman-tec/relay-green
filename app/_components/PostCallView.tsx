    ...
    >
      ...
      <div className="flex-1 space-y-3 overflow-y-auto px-4 py-6">
        {messages.length === 0 ? (
          ...
          messages.map((m) => (
            <MessageBubble key={m.id} message={m} myKind={myKind} />
          ))
        )}
      </div>
    </section>
  ...
  return (
    ...
    >
      ...
      >
        ...
        {onRegenerate &&
          !generating &&
          (summaryState === "summary_ready" ||
            summaryState === "summary_failed" ||
            summaryState === "transcript_unavailable") && (
            <button
            ...
            >
              <RotateCw size={11} />{" "}
              {summaryState === "summary_failed" ? "Retry" : "Regenerate"}
            </button>
          )}
      </div>
        ...
        {generating ? (
          ...
          <div className="flex flex-col items-center gap-3 py-12 text-center">
            ...
            <p
              ...
              style={{ color: "var(--text-muted)" }}
            >
              The Zoom AI Companion summary didn&apos;t land. If recording
              wasn&apos;t started in the meeting, no transcript is produced.
            </p>
          </div>
