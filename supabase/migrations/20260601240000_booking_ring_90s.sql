-- ============================================================================
-- The scheduled-booking ring offer should last 90s (was 120s), matching the
-- rest of the matching system. Only the expires_at interval changes.
-- ============================================================================
...
BEGIN
  ...
  VALUES (_intake, _session.id, _bk.engineer_user_id, _me, 0, now() + interval '90 seconds');
